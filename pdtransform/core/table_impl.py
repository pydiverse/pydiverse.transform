...
class AbstractTableImpl(metaclass=_TableImplMeta):
    ...
    def _bind_values_to_compiled_expr(self, compiled):
        """
        Binds the correct argument to a compiled object expression.
        This is used for nice preview of expressions in IPython.

        :param compiled: A callable generated by the ExpressionCompiler.
        :return: Another callable whose arguments don't matter.
        """
