...
project = "pydiverse.transform"
copyright = f"{datetime.date.today().year}, QuantCo, Inc"
author = "QuantCo, Inc."

release = importlib.metadata.version("pydiverse.transform")
...
html_title = "pydiverse.transform"

html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/pydiverse/pydiverse.transform/",
            "html": """
    ...
    "source_repository": "https://github.com/pydiverse/pydiverse.transform/",
    "source_branch": "main",
...
def linkcode_resolve(domain, info):
    ...
    try:
        ...
        return (
            "https://github.com/pydiverse/pydiverse.transform"
            f"/tree/{release}/src/pydiverse/transform/{fn}{linespec}"
        )
