...
dataframes = {
    ...
    "df_num": pl.DataFrame(
        {
            "a": [0.4, -1.1, -0.0, 0.0, 9.0, 2.0, float("inf"), -1000.0],
            "b": [None, 2, 0, -11, 4, 19, -5190, 2000000],
            "c": [0.0, None, None, 2.9, -0.0, 10.0, -10.0, 3.1415926535],
            "d": [None, float("-nan"), 0.577, 901234, -6.0, 4.0, None, -99.0],
            "e": [1.0, 2.0, 3.0, 4.99, float("nan"), 6.0, 7.0, 500.0],
            "f": [3.0, None, 0.0, 4.3, 10.0, -1.2, -9999.1, -34.1],
            "g": [-5.5, None, None, 1.100212, -3.412351, 1000.4252, 0.0, -1.6],
            "nan": [float("nan"), float("nan"), float("-nan"), float("-nan")] * 2,
            "inf": [float("inf")] * 8,
            "-inf": [float("-inf")] * 8,
            "zero": [0.0, -0.0] * 4,
            "pos": [
            ...
            "null:": [0.0, None, None, None, None, None, None, None],
        }
    ),
}
